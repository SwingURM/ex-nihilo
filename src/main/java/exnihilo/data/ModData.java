...
public class ModData {
    ...
    public static void load(Configuration config) {
        SIEVE_PAIN_MULTIPLIER = config.get(CATEGORY_OPTIONS, SIEVE_PAIN_MULTIPLIER_KEY, SIEVE_PAIN_MULTIPLIER)
            .getInt(SIEVE_PAIN_MULTIPLIER);
        ALLOW_BARRELS = config.get(CATEGORY_OPTIONS, ALLOW_BARRELS_KEY, ALLOW_BARRELS)
            .getBoolean(ALLOW_BARRELS);
        ALLOW_SIEVES = config.get(CATEGORY_OPTIONS, ALLOW_SIEVES_KEY, ALLOW_SIEVES)
            .getBoolean(ALLOW_SIEVES);
        ALLOW_SIEVE_AUTOMATION = config.get(CATEGORY_OPTIONS, ALLOW_SIEVE_AUTOMATION_KEY, ALLOW_SIEVE_AUTOMATION)
            .getBoolean(ALLOW_SIEVE_AUTOMATION);
        LEGACY_SIEVE = config.get(CATEGORY_OPTIONS, LEGACY_SIEVE_KEY, LEGACY_SIEVE)
            .getBoolean(LEGACY_SIEVE);
        ALLOW_CRUCIBLES = config.get(CATEGORY_OPTIONS, ALLOW_CRUCIBLES_KEY, ALLOW_CRUCIBLES)
            .getBoolean(ALLOW_CRUCIBLES);
        ALLOW_HAMMERS = config.get(CATEGORY_OPTIONS, ALLOW_HAMMERS_KEY, ALLOW_HAMMERS)
            .getBoolean(ALLOW_HAMMERS);
        ALLOW_CROOKS = config.get(CATEGORY_OPTIONS, ALLOW_CROOKS_KEY, ALLOW_CROOKS)
            .getBoolean(ALLOW_CROOKS);
        ALLOW_SILKWORMS = config.get(CATEGORY_OPTIONS, ALLOW_SILKWORMS_KEY, ALLOW_SILKWORMS)
            .getBoolean(ALLOW_SILKWORMS);
        ALLOW_BARREL_RECIPE_DIRT = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_DIRT_KEY, ALLOW_BARREL_RECIPE_DIRT)
            .getBoolean(ALLOW_BARREL_RECIPE_DIRT);
        ALLOW_BARREL_RECIPE_CLAY = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_CLAY_KEY, ALLOW_BARREL_RECIPE_CLAY)
            .getBoolean(ALLOW_BARREL_RECIPE_CLAY);
        ALLOW_BARREL_RECIPE_NETHERRACK = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_NETHERRACK_KEY, ALLOW_BARREL_RECIPE_NETHERRACK)
            .getBoolean(ALLOW_BARREL_RECIPE_NETHERRACK);
        ALLOW_BARREL_RECIPE_ENDSTONE = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_ENDSTONE_KEY, ALLOW_BARREL_RECIPE_ENDSTONE)
            .getBoolean(ALLOW_BARREL_RECIPE_ENDSTONE);
        ALLOW_BARREL_RECIPE_SLIME = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_SLIME_KEY, ALLOW_BARREL_RECIPE_SLIME)
            .getBoolean(ALLOW_BARREL_RECIPE_SLIME);
        ALLOW_BARREL_RECIPE_SOULSAND = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_SOULSAND_KEY, ALLOW_BARREL_RECIPE_SOULSAND)
            .getBoolean(ALLOW_BARREL_RECIPE_SOULSAND);
        ALLOW_BARREL_RECIPE_BLAZE_RODS = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_BLAZE_RODS_KEY, ALLOW_BARREL_RECIPE_BLAZE_RODS)
            .getBoolean(ALLOW_BARREL_RECIPE_BLAZE_RODS);
        ALLOW_BARREL_RECIPE_ENDER_PEARLS = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_ENDER_PEARLS_KEY, ALLOW_BARREL_RECIPE_ENDER_PEARLS)
            .getBoolean(ALLOW_BARREL_RECIPE_ENDER_PEARLS);
        ALLOW_BARREL_RECIPE_DARK_OAK = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_DARK_OAK_KEY, ALLOW_BARREL_RECIPE_DARK_OAK)
            .getBoolean(ALLOW_BARREL_RECIPE_DARK_OAK);
        ALLOW_BARREL_RECIPE_DOUBLE_FLOWERS = config
            .get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_RECIPE_DOUBLE_FLOWERS_KEY, true)
            .getBoolean();
        BARREL_ADDITIONS = config
            .get(
                CATEGORY_OPTIONS_BARREL,
                BARREL_ADDITIONS_KEY,
                "",
                "Format: oredictname:amounttofill:color \n Seperate with ;")
            .getString()
            .split(";");
        BARREL_ADDITIONS_NONDICT = config
            .get(
                CATEGORY_OPTIONS_BARREL,
                BARREL_ADDITIONS_NONDICT_KEY,
                "",
                "Format: modid:itemname:meta:amounttofill:color \n Seperate with ;")
            .getString()
            .split(";");
        ALLOW_BARREL_FILL_RAIN = config.get(CATEGORY_OPTIONS_BARREL, ALLOW_BARREL_FILL_RAIN_KEY, true)
            .getBoolean();
        SILKWORM_STRING_PROBABILITY = config
            .get(CATEGORY_OPTIONS_AGRICULTURE, SILKWORM_STRING_PROBABILITY_KEY, SILKWORM_STRING_PROBABILITY)
            .getDouble(SILKWORM_STRING_PROBABILITY);
        OVERWRITE_DEFAULT_MACERATOR_RECIPES = config
            .get(
                CATEGORY_OPTIONS_COMPATIBILITY,
                OVERWRITE_DEFAULT_MACERATOR_RECIPES_KEY,
                OVERWRITE_DEFAULT_MACERATOR_RECIPES)
            .getBoolean(OVERWRITE_DEFAULT_MACERATOR_RECIPES);
        OVERWRITE_DEFAULT_PULVERIZER_RECIPES = config
            .get(
                CATEGORY_OPTIONS_COMPATIBILITY,
                OVERWRITE_DEFAULT_PULVERIZER_RECIPES_KEY,
                OVERWRITE_DEFAULT_PULVERIZER_RECIPES)
            .getBoolean(OVERWRITE_DEFAULT_PULVERIZER_RECIPES);
        LILYPAD_CHANCE = config.get(CATEGORY_OPTIONS_CROOK, LILYPAD_CHANCE_KEY, LILYPAD_CHANCE)
            .getInt();
        CROOK_BLACKLIST = config
            .get(CATEGORY_OPTIONS_CROOK, CROOK_BLACKLIST_KEY, "", "Format: modid:blockname:meta \n Seperate with ;")
            .getString()
            .split(";");
    }
}
