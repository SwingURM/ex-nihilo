...
public class Recipes {
    ...
    public static void registerCraftingRecipes() {
        ...
        if (ModData.ALLOW_SIEVES) for (int i = 0; i < 6; i++) {
            if (!ModData.LEGACY_SIEVE) GameRegistry.addRecipe(
                new ShapedOreRecipe(
                ...
                new ShapedOreRecipe(
                    ...
                    "stickWood",
                    'z',
                    new ItemStack(ENItems.MeshSilk, 1, i)));
        }
        GameRegistry.addRecipe(
        ...
        if (ModData.ALLOW_CRUCIBLES) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(Blocks.cobblestone, 1, 0), "xx", "xx", 'x', ENItems.PebbleStone));
    }

    public static void registerFurnaceRecipes() {
        FurnaceRecipes.smelting()
            .func_151396_a(ENItems.Silkworm, new ItemStack(ENItems.SilkwormCooked, 1, 0), 0.1F);
